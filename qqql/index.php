            ...
            <div class="container">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 templatemo-content-wrapper">
                    <div class="templatemo-content">
						...
						<form method="POST" action="qqtk.php" target=_blank>
						<div class="form-group"><input name="qqnum" type="text" value="" size="21" maxlength="" class="form-control" placeholder="请输入qq号码"></div>
