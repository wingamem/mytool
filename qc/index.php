            ...
            <div class="container">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 templatemo-content-wrapper">
                    <div class="templatemo-content">
						...
						<form name="contactForm" method="post" action="qc.php" target=_blank>
						<div class="form-group"><input name="phone" type="text" value="" size="21" maxlength="" class="form-control" placeholder="请输入号码"></div>
						<input class="btn btn-primary" name="reset" type="reset" value="清空" id="width_2">
						<input class="btn btn-primary" name="submit" type="submit" value="提交" id="width_2">
						</form>
